...
// GET .../usages, bearer-token authenticated, JSON response. This is the
// same managed-usage endpoint the `kimi` CLI itself calls (see
// packages/oauth/src/managed-usage.ts: kimiCodeUsageUrl()) - NOT the local
// `/oauth/usage` route the CLI's own TUI process exposes on its localhost
// server, which is a different thing and 404s here.
